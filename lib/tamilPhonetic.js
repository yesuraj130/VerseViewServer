 ...
 * Note: Asterisk (*) is deliberately preserved to support prefix, suffix, and gap wildcards.
 */
 ...
 */
export function compileQueryPattern(rawQuery)
{
 ...
 */
export function matchWithPrecomputedKeys(targetText, qKeysOrPattern, rawQuery)
{
